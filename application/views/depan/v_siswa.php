                        ...
                        <tbody>
                            <?php
                                ...
                                foreach ($data->result() as $row):
                                    $query = $this->db->get_where('tbl_guru', ['guru_id' => $row->wali_kelas_id])->row_array();
                                    $wali_kelas = $query['guru_nama'];
                                    $wali_kelas_mapel = $query['guru_mapel'];
							?>
                            <tr>
                                <td>
                                ...
                                <td>
                                <?php echo $wali_kelas;?> sebagai Pengajar <?php echo $wali_kelas_mapel;?>
                                </td>
                            </tr>
                                <?php endforeach; ?>
                        </tbody>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="address">
                        <h3>Hubungi Kami</h3>
                        <p><span>Alamat: </span> JL. Mawar No. 70 Kode Pos. 68118, Tegal Rejo, Jember Lor, Kec. Patrang,
