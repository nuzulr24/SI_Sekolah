...
<head>
  ...
  <title>M-Sekolah | Data Kelas</title>
            ...
            <div class="box">
              ...
              <div class="box">
                <div class="box-header">
                  <a class="btn btn-success btn-flat" data-toggle="modal" data-target="#modalKelas"><span
                      class="fa fa-plus"></span> Add Kelas</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
      ...
      <div class="modal-content">
        ...
        <form class="form-horizontal" action="<?php echo base_url().'admin/kelas/update_kelas'?>" method="post"
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label for="inputUserName" class="col-sm-4 control-label">Kelas Nama</label>
              <div class="col-sm-7">
                <input type="text" name="xnis" value="<?php echo $nama;?>" class="form-control" id="inputUserName"
